#This script computes an estimation of the parameters of the harmic oscillator, based on the measurements
...
A_end = peaks_theta[len(peaks_theta)-1]
delta_total = np.log(np.abs(A_start / A_end))
T_total = peaks_time[len(peaks_theta)-1] - peaks_time[0]  # Total time T
...
T_end = peaks_time[len(peaks_theta)-1] - peaks_time[len(peaks_theta)-2]  # Period of the last oscillation
