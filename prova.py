...
with open(r'C:\Users\giuse\OneDrive\Desktop\personale\Triennale\Terzo anno\Secondo semestre\Tesi\myThesis\risposta_rotazionale.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
    for i in range(n):
        writer.writerow([time_values[i], theta[i]])  # Write the data row by row

print("Data saved in 'risposta_rotazionale.csv'")